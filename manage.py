...
#                    help="A RFC1738 URL to a PostgreSQL or SQLite database to use.")
# def prepopulate(url):
#     """ Pre-populate psql or sqlite DB with sample data """
#     _db = DatabaseConnection(url)
#     print u"Connected to {}.".format(repr(_db.engine.url))
#     if yes_no("Are you sure you want to prepopulate the database with sample data?"):
#         with _db.transient_session() as session:
#             from tests.prepopulate import prepopulate_sample_data
#             print "Adding data..."
#             prepopulate_sample_data(session)
